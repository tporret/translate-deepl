...
use TranslateDeepL\Frontend\PatternResolver;
...
use TranslateDeepL\Service\AssetRegistrySyncService;
use TranslateDeepL\Service\AssetRegistryTranslator;
...
final class Plugin
{
    ...
    private function registerServices(): void
    {
        ...
        $this->container->singleton(
            FseAssetCatalog::class,
            static fn (): FseAssetCatalog => new FseAssetCatalog()
        );
        ...
        $this->container->singleton(
            AssetRegistryRepository::class,
            static fn (Container $container): AssetRegistryRepository => new AssetRegistryRepository(
                $container->get(\wpdb::class)
            )
        );
        ...
        $this->container->singleton(
            AssetRegistryTranslator::class,
            static fn (Container $container): AssetRegistryTranslator => new AssetRegistryTranslator(
                $container->get(BlockProcessor::class),
                $container->get(DeepLApiClient::class),
                $container->get(TranslationMemoryRepository::class),
                $container->get(AssetRegistryRepository::class)
            )
        );

        $this->container->singleton(
            AssetRegistrySyncService::class,
            static fn (Container $container): AssetRegistrySyncService => new AssetRegistrySyncService(
                $container->get(AssetRegistryRepository::class),
                $container->get(FseAssetCatalog::class)
            )
        );
        ...
        $this->container->singleton(
            ...
            static fn (Container $container): JobManager => new JobManager(
                ...
                $container->get(AssetRegistryTranslator::class)
            )
        );
        ...
        $this->container->singleton(
            ...
            static fn (Container $container): PatternResolver => new PatternResolver(
                $container->get(AssetRegistryRepository::class),
                $container->get(PostRelationRepository::class),
                $container->get(FseAssetCatalog::class)
            )
    ...
    public function onPluginsLoaded(): void
    {
        ...
        $this->container->get(AssetRegistrySyncService::class)->registerHooks();
        ...
        $this->container->get(PatternResolver::class)->registerHooks();
    }
}
