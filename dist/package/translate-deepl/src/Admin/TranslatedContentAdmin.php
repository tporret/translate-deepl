...
final class TranslatedContentAdmin
{
    ...
    public function registerHooks(): void
    {
        ...
        add_filter('manage_edit-wp_block_sortable_columns', [$this, 'addSortableLanguageColumn']);
        ...
        add_action('manage_wp_block_posts_custom_column', [$this, 'renderLanguageColumn'], 10, 2);
    ...
    public function filterListQuery(\WP_Query $query): void
    {
        ...
        if (! in_array($postType, ['post', 'page', 'wp_block'], true)) {
            return;
        }
    ...
    private function shouldShowLanguageColumn(): bool
    {
        ...
        return in_array($postType, ['post', 'page', 'wp_block'], true);
    }
}
